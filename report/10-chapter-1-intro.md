...
| :---: | :--- | :--- |
| <img src="../assets/img/team/duarte-drago.png" alt="Drago Derick Duarte Ruffner" width="110" style="border-radius: 8px;"/> | **Apellidos y Nombres:**<br>Duarte Ruffner, Drago Derick<br><br>**Código:**<br>U202315120 | **Carrera:**<br>Ingeniería de Software<br><br>**Conocimientos técnicos y habilidades:**<br>Tengo 22 años y soy estudiante de la carrera de Ingeniería de Software. Me gusta colaborar con mi equipo, apoyarlos en lo que esté a mi alcance y aprender de lo que ellos pueden aportar. Busco adquirir nuevos conocimientos que sumen a mi futuro profesional, apoyándome en la inteligencia artificial como una herramienta para mejorar tanto en el desarrollo backend como frontend. Además, aplico los principios de programación orientada a objetos y diseño de experiencia de usuario (UX/UI), y actualmente sigo aprendiendo el uso de Gitflow para contribuir de la mejor manera en las entregas de mi grupo. |
